...
// 6 render styles. draw_background() builds the desktop from the chosen base color
...
enum {
    ...
    WP_STYLE_AURORA,      // Nightfall scene with slow ANIMATED aurora/nebula curtains
    WP_STYLE_COUNT
};

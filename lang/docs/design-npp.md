...
| M6.5c | `pub` scoped to importers: a `pub` item visible only to the files that `use` its module (today it is visible program-wide); re-exports | pending |

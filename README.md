...
<div align="center">
  ...
  <br/><br/>
  <!-- Badges -->
  <a href="https://github.com/kazah-png/nyx-os/releases/tag/v5.8.30">
    <img src="https://img.shields.io/badge/release-v5.8.30-00ff9d?style=flat" />
  </a>
  <img src="https://img.shields.io/badge/status-v5.8.30-00ff9d?style=flat" />
...
- **31 syscalls** via `syscall`/`sysret`: `exit`, `write`, `print`, `open`, `read`, `close`, `getpid`, `sbrk`, `fsize`, `exec`, `fork`, `waitpid`, `pipe`, `execve`, `dup2`, `getdents`, `kill`, `signal`, `sigreturn`, `mmap`, `munmap`, `chdir`, `getcwd`, `mkdir`, `unlink`, `ttymode`, `mprotect`, `getprocs`, `readkey`, `dlopen`, `dlsym`

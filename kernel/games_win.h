...
// The "Games" desktop folder (v5.9.40). A plain compositor window that visually
// lists the built-in games — Minesweeper, DOOM and Pong — as clickable icons,
// each drawn as a little preview of the game, and launches the one you click.
// It is a folder in spirit only: there is no filesystem behind it, just a fixed
// menu, which is exactly what a "games shelf" on the desktop needs to be.

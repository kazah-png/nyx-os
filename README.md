...
<div align="center">
  ...
  <br/><br/>
  <!-- Badges -->
  <a href="https://github.com/kazah-png/nyx-os/releases/tag/v5.8.42">
    <img src="https://img.shields.io/badge/release-v5.8.42-00ff9d?style=flat" />
  </a>
  <img src="https://img.shields.io/badge/status-v5.8.42-00ff9d?style=flat" />
...
<div align="center">
  <img src="gui.png?v=3" alt="NyxOS Desktop v5.8.42" width="700" />
...
- Userspace `sh` (`/sh.elf`): real `fork`/`execve` pipelines, `&` background jobs (`jobs`/`fg`/`bg`), globbing (`*` `?`), `~` expansion, command-list operators **`&&` / `\|\|` / `;`** (short-circuit on `$?`), and **command substitution `$(cmd)`** (runs `cmd` in a subshell and splices its output; nests)

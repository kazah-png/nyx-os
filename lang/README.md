...
<p align="center">
  <img src="https://img.shields.io/badge/N-v0.4-825AD2?style=flat" />
  &nbsp;
...
| Status | **v0.4 — working** (see below) | **P1 complete** (the checker lives in `ncc`) |
...
dependencies) implements N v0.4 — type inference (typed `:=` bindings with an
...
with `file:line` diagnostics), strict-C99 output — and is verified three ways:
